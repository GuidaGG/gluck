...
class MergedInlineAdmin(admin.ModelAdmin):
    ...
    class Media:
        js = ('admin/js/jquery.min.js','admin/js/merged_inlines.js',)
                    ...
                    for line in fieldset:
                        for field in line:
                            ...
                            if(hasattr(field.field, 'name')):
                                ...
                                variable2 = field.field.label
                                variable3 = field.field.is_hidden
                            else:
                                variable ='image_tag'
                                variable2 = 'image_tag'
                                variable3 = False
                            if ( variable , variable2) not in all_fields and not variable3: 
                                    all_fields.append(
                                                (variable, variable2)
                                        )
                            if(hasattr(field.field, 'name')):
                                all_forms[i][1][variable] = field
                                print(variable)
                            else:
                                print(field)
                                all_forms[i][1]['image_tag'] = field
                i += 1
